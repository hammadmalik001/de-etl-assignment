...
def main():
    print('Waiting for the data generator to start...')
    sleep(20)
    print('ETL Starting...')
    ...
    # Add time_hour column in the DataFrame to add the hour value for each record
    ...
    print("Here is the final data that will be loaded into the MySQL table.")
    print(df.head(10))
    ...
    try:
        ...
        print(f"Error occurred while loading data into table {mysql_table_name}: {str(e)}")
    finally:
        psql_engine.dispose()
